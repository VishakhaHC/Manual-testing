...
driver.findElement(By.xpath("/html/body/header/nav/div/div/ul/li[4]/ul/li[3]/a/span")).click();
System.out.println("vedio opened sucessfully");
driver.close();
}
}
